                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="svg-shapes">
                            ...
                            <ul class="svg-shapes">
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape69">HTML5 logo
                                        (<strong>96</strong> paths)
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape110"><strong>1004</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape118"><strong>1173</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape116"><strong>1196</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape114"><strong>1269</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape130"><strong>1800</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                ...
                                <li>
                                    <button class="btn btn-small shape" id="shape41"><strong>12361</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape67"><strong>12604</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape24"><strong>12866</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape27"><strong>13905</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape49"><strong>14174</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape33"><strong>17059</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape20"><strong>19035</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape35"><strong>19271</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape44"><strong>22375</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape72"><strong>29303</strong>
                                        paths
                                    </button>
                                </li>
                                <li>
                                    <button class="btn btn-small shape" id="shape48"><strong>41787</strong>
                                        paths
                                    </button>
                                </li>
                        ...
                        <div class="tab-pane" id="simple-shapes">
                            ...
                            <p>
                                ...
                                <button type="button" class="btn polygon" ng-click="addPolygon()">Polygon
                                </button>
                            </p>
                            ...
                            <p>
                                ...
                                <button type="button" class="btn image2" ng-click="addImage2()">Image 2
                                    (google)
                                </button>
                                <button type="button" class="btn image3" n-click="addImage3()">Image 3
                                    (printio)
                                </button>
                            </p>
                        ...
                        <div class="tab-pane active" id="object-controls-pane">
                            <div id="global-controls">
                                <p>
                                    ...
                                    <button class="btn btn-success" id="rasterize-svg"
                                            ng-click="rasterizeSVG()">
                                        SVG
                                    </button>
                                    <button class="btn btn-success" id="rasterize-json"
                                            ng-click="rasterizeJSON()">
                                        JSON
                                    </button>
                                </p>
                                <p>
                                    <button class="btn btn-danger clear" ng-click="confirmClear()">Clear
                                        canvas
                                    </button>
                                </p>
                            </div>
                            ...
                            <div class="object-controls" object-buttons-enabled="getSelected()">
                                ...
                                <div style="margin-top:10px;">
                                    ...
                                    <button class="btn btn-lock btn-object-action"
                                        ...
                                        {[ getVerticalLock() ? 'Unlock vertical movement' : 'Lock vertical
                                        movement' ]}
                                    </button>
                                    <br>
                                    <button class="btn btn-lock btn-object-action"
                                        ...
                                        {[ getScaleLockX() ? 'Unlock horizontal scaling' : 'Lock horizontal
                                        scaling' ]}
                                    </button>
                                    <br>
                                    <button class="btn btn-lock btn-object-action"
                                ...
                                <div style="margin-top:10px">
                                    <p>
                                        ...
                                        <label>
                                            Left
                                            <input type="radio" name="origin-x"
                                                   class="origin-x btn-object-action"
                                                   value="left"
                                    ...
                                    <p>
                                        ...
                                        <label>
                                            Top
                                            <input type="radio" name="origin-y"
                                                   class="origin-y btn-object-action"
                                                   value="top"
                                ...
                                <div style="margin-top:10px;">
                                    <button id="gradientify" class="btn btn-object-action"
                                    ...
                                    <button id="patternify" class="btn btn-object-action"
                                            ng-click="patternify()">
                                        Patternify
                                    </button>
                            ...
                            <div style="margin-top:10px;" id="drawing-mode-wrapper">
                                ...
                                <button id="drawing-mode" class="btn btn-info"
                                    ...
                                    {[ getFreeDrawingMode() ? 'Exit free drawing mode' : 'Enter free drawing
                                    mode' ]}
                                </button>
